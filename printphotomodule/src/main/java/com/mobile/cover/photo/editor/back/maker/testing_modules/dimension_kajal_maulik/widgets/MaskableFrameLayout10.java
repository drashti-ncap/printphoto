...
public class MaskableFrameLayout10 extends FrameLayout {
    ...
    public MaskableFrameLayout10(Context context) {
        super(context);
    }

    public MaskableFrameLayout10(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskableFrameLayout10(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableFrameLayout10.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableFrameLayout10.this.getViewTreeObserver();
                    }
