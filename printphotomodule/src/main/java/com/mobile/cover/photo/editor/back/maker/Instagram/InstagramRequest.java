package com.mobile.cover.photo.editor.back.maker.Instagram;

import android.os.AsyncTask;
import android.util.Log;


import com.mobile.cover.photo.editor.back.maker.Instagram.util.Cons;
import com.mobile.cover.photo.editor.back.maker.Instagram.util.Debug;
import com.mobile.cover.photo.editor.back.maker.Instagram.util.StringUtil;
...
public class InstagramRequest {
    ...
    private String requestPost(String endpoint, List<NameValuePair> params) throws Exception {
        String requestUri = Cons.API_BASE_URL + ((endpoint.indexOf("/") == 0) ? endpoint : "/" + endpoint);
        Log.e("REQUESTED_URL", "requestPost: " + requestUri);
     ...
     * Create http POST request to an instagram api endpoint.
     *
     * @param params requestUri Api url
     * @param params Request parameters
     * @return Api response in json format.
     * @throws Exception If error occured.
     */
