...
public class MaskableFrameLayout1 extends FrameLayout {
    ...
    public MaskableFrameLayout1(Context context) {
        super(context);
    }

    public MaskableFrameLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskableFrameLayout1(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableFrameLayout1.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableFrameLayout1.this.getViewTreeObserver();
                    }
