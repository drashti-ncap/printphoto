...
public class MaskableFrameLayout7 extends FrameLayout {
    ...
    public MaskableFrameLayout7(Context context) {
        super(context);
    }

    public MaskableFrameLayout7(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskableFrameLayout7(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableFrameLayout7.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableFrameLayout7.this.getViewTreeObserver();
                    }
