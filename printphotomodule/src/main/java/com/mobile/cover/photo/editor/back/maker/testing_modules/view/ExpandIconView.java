...
public class ExpandIconView extends View {
    ...
    public ExpandIconView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.fraction = TextTrackStyle.DEFAULT_FONT_SCALE;
        ...
        try {
            ...
            long animationDuration = array.getInteger(array.getIndex(5), 150);
    ...
    public void setFraction(@FloatRange(from = 0.0d, to = 1.0d) float fraction, boolean animate) {
        if (fraction < 0.0f || fraction > TextTrackStyle.DEFAULT_FONT_SCALE) {
    ...
    private void updateArrowPath() {
        ...
        if (this.left != null && this.right != null) {
            rotate(this.left, -this.alpha, this.tempLeft);
    ...
    private void animateArrow(float toAlpha) {
        cancelAnimation();
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(this.alpha, toAlpha);
