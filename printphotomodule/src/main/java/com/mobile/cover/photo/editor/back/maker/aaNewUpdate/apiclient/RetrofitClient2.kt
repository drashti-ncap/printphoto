...
import com.mobile.cover.photo.editor.back.maker.aaNewUpdate.utilities.getBaseUrlPaytm
...
class RetrofitClient2(val mContext: Context) {
        ...
        get() {
            ...
            if (retrofit == null) {
                retrofit = Retrofit.Builder()
                        .baseUrl(mContext.getBaseUrlPaytm())
                        .client(httpClient)
