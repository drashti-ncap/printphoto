...
public class MaskableFrameLayout11 extends FrameLayout {
    ...
    public MaskableFrameLayout11(Context context) {
        super(context);
    }

    public MaskableFrameLayout11(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskableFrameLayout11(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableFrameLayout11.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableFrameLayout11.this.getViewTreeObserver();
                    }
    ...
    public void swapBitmapMask(@Nullable Bitmap newMask) {
        ...
        Log.e("swapBitmapMask", "newMask --> " + newMask);
