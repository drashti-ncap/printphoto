...
public class MaskableFrameLayout2 extends FrameLayout {
    ...
    public MaskableFrameLayout2(Context context) {
        super(context);
    }

    public MaskableFrameLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskableFrameLayout2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableFrameLayout2.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableFrameLayout2.this.getViewTreeObserver();
                    }
