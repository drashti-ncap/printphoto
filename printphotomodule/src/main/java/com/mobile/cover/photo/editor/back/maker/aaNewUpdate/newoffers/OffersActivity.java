...
public class OffersActivity extends AppCompatActivity {
    ...
    private void initviews() {
        ...
        mAdapter = new OfferAdapter(this, sqlist, sqlist2, sqlist3);
    ...
    private void getoffer() {
        ...
        if (SharedPrefs.getString(OffersActivity.this, SharedPrefs.country_code).equalsIgnoreCase("IN")) {
            call = api.getoffer("", "0", SharedPrefs.getString(OffersActivity.this, SharedPrefs.uid), Locale.getDefault().getLanguage(), SharedPrefs.getString(OffersActivity.this, SharedPrefs.country_code));
        } else {
            call = api.getoffer("", "1", SharedPrefs.getString(OffersActivity.this, SharedPrefs.uid), Locale.getDefault().getLanguage(), SharedPrefs.getString(OffersActivity.this, SharedPrefs.country_code));
        }
