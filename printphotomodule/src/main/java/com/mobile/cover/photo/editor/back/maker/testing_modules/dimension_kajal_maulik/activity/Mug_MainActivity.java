...
public class Mug_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mug_set_activity);
//        position = getIntent().getExtras().getInt("position");
//        position = 23;
        activity = Mug_MainActivity.this;
        ...
        rl_main.getLayoutParams().width = (int) (device_width / 1.25);
        rl_main.getLayoutParams().height = (int) (device_height / 1.65);

        Log.e("WIDTH", "onCreate: " + (device_width / 1.25));
        Log.e("HEIGTH", "onCreate: " + (device_height / 1.65));
...
//                bitmap=Bitmap.createScaledBitmap(bitmap,1400*2,2489*2,true);
                    ...
                    if (Share.bitmap_testing != null) {
                        if (DataHelperKt.getProductId(activity) == 10) {

                            Intent intent = new Intent(Mug_MainActivity.this, Dynamic_EditActivity.class);
                            intent.putExtra("model_name", Share.model_name);
                            intent.putExtra("model_id", "" + Share.model_id);
                            intent.putExtra("user_id", SharedPrefs.getString(Mug_MainActivity.this, Share.key_ + RegReq.id));
                            ...
                            Intent intent = new Intent(Mug_MainActivity.this, CoffeeMugEditActivity.class);
                            intent.putExtra("model_name", Share.model_name);
                            intent.putExtra("model_id", "" + Share.model_id);
                            intent.putExtra("user_id", SharedPrefs.getString(Mug_MainActivity.this, Share.key_ + RegReq.id));
                            intent.putExtra("quantity", "1");
                    ...
                    Toast.makeText(Mug_MainActivity.this, getString(R.string.image_processing), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void startMasking() {
        ...
        switch ( DataHelperKt.getCaseId(activity)) {
            ...
            case 2:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.45)), (int) (device_height - (device_height / 2.35)), (int) (device_width - (device_width / 1.2)), (int) (device_height - (device_height / 1.07))));//1
            ...
            case 3:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.45)), (int) (device_height - (device_height / 2.35)), (int) (device_width - (device_width / 1.05)), (int) (device_height - (device_height / 1.04))));//1
            ...
            case 4:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.5)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.04)), (int) (device_height - (device_height / 1.04))));//1
                dimen_frame_2.add(new DimensionModel((int) (device_width - (device_width / 1.5)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.75)), (int) (device_height - (device_height / 1.04))));//1
            ...
            case 5:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.45)), (int) (device_height - (device_height / 2.35)), (int) (device_width - (device_width / 1.04)), (int) (device_height - (device_height / 1.05))));//1
            ...
            case 6:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.8)), (int) (device_height - (device_height / 3.75)), (int) (device_width - (device_width / 1.175)), (int) (device_height - (device_height / 1))));//1
            ...
            case 7:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.55)), (int) (device_height - (device_height / 3.75)), (int) (device_width - (device_width / 1)), (int) (device_height - (device_height / 1))));//1
                maskable_fl_1.setMask(R.drawable.mask24_1);
            ...
            case 8:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.44)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.18)), (int) (device_height - (device_height / 1.05))));//1
            ...
            case 9:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 2)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1)), (int) (device_height - (device_height / 1.1))));//1
            ...
            case 10:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.55)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.1)), (int) (device_height - (device_height / 1.161))));//1
            ...
            case 11:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.38)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.38)), (int) (device_height - (device_height / 1.05))));//1
                ...
                break;
            case 12:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.4)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.08)), (int) (device_height - (device_height / 1.05))));//1
                ...
                break;
            case 13:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.7)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.05)), (int) (device_height - (device_height / 1.05))));//1
                ...
                break;
            case 14:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.8)), (int) (device_height - (device_height / 2.6)), (int) (device_width - (device_width / 1.23)), (int) (device_height - (device_height / 1))));//1
                ...
                break;
            case 15:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.68)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 2)), (int) (device_height - (device_height / 1.15))));//1
                ...
                break;
            case 16:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 2.1)), (int) (device_height - (device_height / 1.7)), (int) (device_width - (device_width / 1.165)), (int) (device_height - (device_height / 1.2))));//1
                ...
                break;
            case 17:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.38)), (int) (device_height - (device_height / 2)), (int) (device_width - (device_width / 1.1)), (int) (device_height - (device_height / 1.05))));//1
                ...
                break;
            case 18:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.48)), (int) (device_height - (device_height / 2.2)), (int) (device_width - (device_width / 1.28)), (int) (device_height - (device_height / 1.05))));//1
            ...
            case 21:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.5)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.04)), (int) (device_height - (device_height / 1.04))));//1
                dimen_frame_2.add(new DimensionModel((int) (device_width - (device_width / 1.5)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.65)), (int) (device_height - (device_height / 1.04))));//1
                ...
                break;
            case 22:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.25)), (int) (device_height - (device_height / 1.9)), (int) (device_width - (device_width / 1.1)), (int) (device_height - (device_height / 1.04))));//1
                dimen_frame_2.add(new DimensionModel((int) (device_width - (device_width / 1.25)), (int) (device_height - (device_height / 1.9)), (int) (device_width - (device_width / 1.35)), (int) (device_height - (device_height / 1.04))));//1
                ...
                break;
            case 23:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 2)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.2)), (int) (device_height - (device_height / 1))));//1
                ...
                break;
            case 24:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.6)), (int) (device_height - (device_height / 2.4)), (int) (device_width - (device_width / 1.7)), (int) (device_height - (device_height / 1.04))));//1
                ...
                break;
            case 25:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.8)), (int) (device_height - (device_height / 2.6)), (int) (device_width - (device_width / 1.7)), (int) (device_height - (device_height / 1))));//1
            ...
            case 26:
                ...
                break;
            case 27:
                dimen_frame_1.add(new DimensionModel((int) (device_width - (device_width / 1.65)), (int) (device_height - (device_height / 2.6)), (int) (device_width - (device_width / 1)), (int) (device_height - (device_height / 1))));//1
    ...
    private void setimage() {
        ...
        for (int i = 0; i < mainapplication.org_selectedImages.size(); i++) {
            if (i == 0) {
                Glide.with(Mug_MainActivity.this).asBitmap().load(mainapplication.org_selectedImages.get(i).getImagePath()).into(new SimpleTarget<Bitmap>() {
                    @Override
