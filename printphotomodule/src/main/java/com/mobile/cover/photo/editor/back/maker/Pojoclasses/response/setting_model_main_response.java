...
public class setting_model_main_response {
    ...
    @SerializedName("data")
    @Expose
    private setting_response_data data;
    ...
    public setting_response_data getData() {
        return data;
    }

    public void setData(setting_response_data data) {
        this.data = data;
    }
