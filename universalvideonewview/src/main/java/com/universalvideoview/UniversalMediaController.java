...
public class UniversalMediaController extends FrameLayout {
    ...
    private View.OnClickListener mRetryListener = new View.OnClickListener() {
        public void onClick(View v) {
            Log.e("onClick: ", "mRetryListener");

            /*if (viewRoot != null)
                initControllerView(viewRoot);*/
            mSeekListener.onProgressChanged((SeekBar) mProgress, mProgress.getProgress(), true);
        }
    };
    ...
    private void init(Context context) {
        ...
        viewRoot = inflater.inflate(R.layout.uvv_player_controller, this);
...
//        iv_retry = v.findViewById(R.id.iv_retry);
        ...
        /*if (iv_retry != null) {
            iv_retry.setOnClickListener(mRetryListener);
        }*/
